  ...
  for (r in names(AllStats)){
    ...
    dfSummary <- dplyr::bind_rows(dfSummary,
                                  data.frame("Ftgt" = rep(r,length(intersect(dimnames(t$IAV$val["50%"])$year,ac(yrs)))),
                                             ...
                                             "p1" = as.numeric(t$IAV$val["1%",intersect(dimnames(t$IAV$val["1%"])$year,ac(yrs))])/1e3,
                                             "p2.5" = as.numeric(t$IAV$val["2.5%",intersect(dimnames(t$IAV$val["2.5%"])$year,ac(yrs))])/1e3,
                                             "p5" = as.numeric(t$IAV$val["5%",intersect(dimnames(t$IAV$val["5%"])$year,ac(yrs))])/1e3,
                                             "p25" = as.numeric(t$IAV$val["25%",intersect(dimnames(t$IAV$val["25%"])$year,ac(yrs))])/1e3,
                                             "p50" = as.numeric(t$IAV$val["50%",intersect(dimnames(t$IAV$val["50%"])$year,ac(yrs))])/1e3,
                                             "p75" = as.numeric(t$IAV$val["75%",intersect(dimnames(t$IAV$val["75%"])$year,ac(yrs))])/1e3,
                                             "p95" = as.numeric(t$IAV$val["95%",intersect(dimnames(t$IAV$val["95%"])$year,ac(yrs))])/1e3,
                                             "p97.5" = as.numeric(t$IAV$val["97.5%",intersect(dimnames(t$IAV$val["97.5%"])$year,ac(yrs))])/1e3,
                                             "p99" = as.numeric(t$IAV$val["99%",intersect(dimnames(t$IAV$val["99%"])$year,ac(yrs))])/1e3,
                                             "ref" = 0,
                                             stringsAsFactors = FALSE))
