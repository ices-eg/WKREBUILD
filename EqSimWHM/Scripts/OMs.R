...
OM2.2.WR <- list("code" = "OM2.2.WR",
              "desc" = "WGWIDE19; wrong reference points",
              "IM" = NA,
              "RecAR" = TRUE, maxRecRes = c(3,-3),
              "BioYrs" = c(2008,2017), "BioConst" = FALSE, 
              "SelYrs" = c(2008,2017), "SelConst" = FALSE,
...
OM2.2.RR.V5 <- list("code" = "OM2.2.RR.V5",
                    "desc" = "WGWIDE19 RR mean recent",
                    "IM" = NA,
                    "RecAR" = TRUE, maxRecRes = c(3,-3),
                    "BioYrs" = c(2008,2017), "BioConst" = FALSE, 
                    "SelYrs" = c(2008,2017), "SelConst" = FALSE,
...
OM2.2.RR.V6 <- list("code" = "OM2.2.RR.V6",
                    "desc" = "WGWIDE19 RR halved",
                    "IM" = NA,
                    "RecAR" = TRUE, maxRecRes = c(3,-3),
                    "BioYrs" = c(2008,2017), "BioConst" = FALSE, 
                    "SelYrs" = c(2008,2017), "SelConst" = FALSE,
...
OM2.2.RR.V7 <- list("code" = "OM2.2.RR.V7",
                    "desc" = "WGWIDE19 RR mean lowest 5",
                    "IM" = NA,
                    "RecAR" = TRUE, maxRecRes = c(3,-3),
                    "BioYrs" = c(2008,2017), "BioConst" = FALSE, 
                    "SelYrs" = c(2008,2017), "SelConst" = FALSE,
...
#WGWIDE2020 Update assessment, IBPWHM reference points, stochastic bio and selection
OM2.3.WR <- list("code" = "OM2.3.WR",
              "desc" = "WGWIDE20; wrong reference points",
              "IM" = NA,
              "SRR" = "SRR.WG20.SegReg_Blim.exterm", "RecAR" = TRUE, maxRecRes = c(3,-3),
              "BioYrs" = c(2009,2018), "BioConst" = FALSE, 
              "SelYrs" = c(2009,2018), "SelConst" = FALSE,
...
OM2.4.WR <- list("code" = "OM2.4.WR",
              "desc" = "WGWIDE19_sam, wrong ref points",
              "IM" = NA,
              "SRR" = "SRR.WG19.SegReg_Blim.exterm", "RecAR" = TRUE, maxRecRes = c(3,-3),
              "BioYrs" = c(2008,2017), "BioConst" = FALSE, 
              "SelYrs" = c(2008,2017), "SelConst" = FALSE,
